...
<div class="btn-group float-right">
	...
	<div class="dropdown-menu" aria-labelledby="dropdownMenuLink" style="font-size: 15px;">
	  <a href='#' class="dropdown-item" data-toggle='modal' data-target='#harian'>Laporan Harian</a>
...
<div class="modal fade" id="harian" tabindex="1" role="dialog" aria-labelledby="edit" aria-hidden="true" >
  ...
  <div class="modal-content">
	...
	<input type="hidden" name="laporan" value="harian">
		<div class="form-group row">
			<label class="col-md-5" style="font-size: 20px;">&nbsp;Dari tanggal &nbsp;</label>
			<input type="date" class="form-control col-7" name="daritanggal" max="<?php echo $tanggalhariini;?>">
		</div> 
		<div class="form-group row">
			<label class="col-md-5" style="font-size: 20px;">&nbsp;Sampai tanggal &nbsp;</label>
			<input type="date" class="form-control col-7" name="sampaitanggal" value="<?php echo $tanggalhariini;?>" max="<?php echo $tanggalhariini;?>">
		</div>                                    
	</div>          
